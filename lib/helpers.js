    ...
    return Object.keys(obj).some((key) => {
      if (Array.isArray(obj[key])) {
        return obj[key].some((entry) => {
          return Object.keys(entry).some((kkey) => {
            if (typeof entry[key] === "string" || entry[key] instanceof String) {
              console.log(entry[kkey]);

              return entry[kkey].toString().toLowerCase().includes(inputvalue.toLowerCase());
            }
          });
        });
      } else {
        ...
        if (typeof obj[key] === "string" || obj[key] instanceof String) {
          /*
          console.log(
            obj[key].toLowerCase().includes(inputvalue.toLowerCase()),
            obj[key],
            obj
          );
*/
    ...
    return searchKeyArray.every(function (searchKey) {
      return Object.keys(obj).some((key) => {
        if (Array.isArray(obj[key])) {
          return obj[key].some((entry) => {
            return Object.keys(entry).some((kkey) => {
              if (typeof entry[kkey] === "string" || entry[kkey] instanceof String) {
                return entry[kkey].toString().toLowerCase().includes(searchKey.toLowerCase());
              }
            });
          });
        } else {
...
let f = (e, iv, parentkey, fields) => {
  if (Array.isArray(e)) {
    ...
    if ((e !== null && typeof e === "string") || e instanceof String) {
      // console.log(e, fields, parentkey);
